...
import { Grid, Card, Checkbox, Input, Icon } from 'semantic-ui-react'
    ...
    <Fragment>
      <Grid.Row>
        <Input
          ...
          onChange={e => this.props.changeMinValueFER(e.target.value)}
        />
      </Grid.Row>
      <Grid.Row>
        Select a minimum value to consider, so as to not divide by zero. Pay attention
        to the ensure consistency with chosen units.
      </Grid.Row>
    </Fragment>
  )

  minValueHasError = () =>
    this.props.errors.minValueFER === '' || /^\d$/.test(this.props.errors.minValueFER)
      ? null
      : true
    ...
    <Grid container centered>
      <Grid.Column>
        <Card fluid color="teal">
          ...
          <Card.Content>
            <Card.Description>Select error(s) to compute:</Card.Description>
            <br />
            <Grid.Row>
              <Checkbox
